 ...
 *
 * @author jingbin
 * https://github.com/youlookwhat/RecyclerView
 */
public class SpacesItemDecoration extends androidx.recyclerview.widget.RecyclerView.ItemDecoration {
    ...
    /**
     * Creates a divider {@link androidx.recyclerview.widget.RecyclerView.ItemDecoration}
     *
     ...
     * {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} changes orientation.
     *
    ...
    @Override
    public void onDraw(Canvas canvas, androidx.recyclerview.widget.RecyclerView parent, androidx.recyclerview.widget.RecyclerView.State state) {
    ...
    private void drawVertical(Canvas canvas, androidx.recyclerview.widget.RecyclerView parent, androidx.recyclerview.widget.RecyclerView.State state) {
        canvas.save();
        final int left;
        final int right;
    ...
    private void drawHorizontal(Canvas canvas, androidx.recyclerview.widget.RecyclerView parent, androidx.recyclerview.widget.RecyclerView.State state) {
        canvas.save();
        final int top;
        final int bottom;
        //noinspection AndroidLintNewApi - NewApi lint fails to handle overrides.
    ...
    public void getItemOffsets(Rect outRect, View view, androidx.recyclerview.widget.RecyclerView parent, androidx.recyclerview.widget.RecyclerView.State state) {
        ...
        // 滚动条置顶
        boolean isFixScrollTop = position == 0;
...
//作者：景彬
//链接：https://www.imooc.com/article/301096
//来源：慕课网